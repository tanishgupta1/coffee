...
public class Coffee implements Beverage {
  ...
  public static Coffee getObject(Long hotWaterIngredient, Long gingerSyrup, Long sugarSyrup, Long teaLeavesSyrup, Long hotMilkIngredient) {
    return Coffee.builder().hotWater(HotWaterIngredient.builder().quantity(hotWaterIngredient).build())
                   ...
                   .hotMilkIngredient(HotMilkIngredient.builder().quantity(hotMilkIngredient).build())
                   .build();
  }

  public Boolean validate(Map<String, Ingredient> globalIngredients) {
    if(!globalIngredients.containsKey("hot_water")) {
      System.out.println("Hot Coffee cannot be prepared because hot water is not available");
      return false;
    } else if(!globalIngredients.containsKey("ginger_syrup")) {
      System.out.println("Hot Coffee cannot be prepared because ginger_syrup is not available");
      return false;
    } else if(!globalIngredients.containsKey("sugar_syrup")) {
      System.out.println("Hot Coffee cannot be prepared because sugar_syrup is not available");
      return false;
    } else if(!globalIngredients.containsKey("tea_leaves_syrup")) {
      System.out.println("Hot Coffee cannot be prepared because tea_leaves_syrup is not available");
      return false;
    } else if(!globalIngredients.containsKey("hot_milk")) {
      System.out.println("Hot Coffee cannot be prepared because hot_milk is not available");
      return false;
    }
    ...
    if (hotWaterRemaining < 0) {
      System.out.println("Hot Coffee cannot be prepared because item hot_water is 0");
      return false;
    } else if (gingerSyrupRemaining < 0) {
      System.out.println("Hot Coffee cannot be prepared because item ginger_syrup is 0");
      return false;
    } else if (sugarSyrupRemaining < 0) {
      System.out.println("Hot Coffee cannot be prepared because item sugar_syrup is 0");
      return false;
    } else if (teaLeavesSyrupRemaining < 0) {
      System.out.println("Hot Coffee cannot be prepared because item tea_leaves_syrup is 0");
      return false;
    } else if (hotMilkRemaining < 0) {
      System.out.println("Hot Coffee cannot be prepared because item hot_milk is 0");
      return false;
    }
